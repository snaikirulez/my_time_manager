...
renderHTMLElementTemplate(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_3__["createSiteMenuTemplate"], siteHeaderElement);
renderHTMLElementTemplate(_components_filter_js__WEBPACK_IMPORTED_MODULE_1__["createSiteFilterTemplate"], siteMainElement);
renderHTMLElementTemplate(_components_board_js__WEBPACK_IMPORTED_MODULE_0__["createBoardTemplate"], siteMainElement);

const boardTasksElement = siteMainElement.querySelector(`.board__tasks`);
renderHTMLElementTemplate(_components_task_edit_js__WEBPACK_IMPORTED_MODULE_4__["createTaskEditTemplate"], boardTasksElement);
for (let i = 0; i <= NUBMER_CREATE_TASK; i++) {
  renderHTMLElementTemplate(_components_task_js__WEBPACK_IMPORTED_MODULE_5__["createTaskTemplate"], boardTasksElement);
}


const boardElement = siteMainElement.querySelector(`.board`);
renderHTMLElementTemplate(_components_load_more_button_js__WEBPACK_IMPORTED_MODULE_2__["createLoadMoreButtonTemplate"], boardElement);
